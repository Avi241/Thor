...
% 
    ...
    if(draw)
        f = figure();
        tit1 = "Arm positions, after a movement.";
        ...
        f.CurrentAxes.Children(2).FaceColor = [1.00 0.00 0.00]; % Wrist
        f.CurrentAxes.Children(3).FaceColor = [1.00 0.00 0.00]; % Forearm
        f.CurrentAxes.Children(4).FaceColor = [1.00 0.00 0.00]; % Elbow
        f.CurrentAxes.Children(5).FaceColor = [1.00 0.00 0.00]; % Arm
        f.CurrentAxes.Children(6).FaceColor = [1.00 0.00 0.00]; % Shoulder
        f.CurrentAxes.Children(7).FaceColor = [1.00 0.00 0.00]; % Support
